...
#ifndef MAIN_INTERFACE__SRV__DETAIL__RESET_ODOM__FUNCTIONS_H_
#define MAIN_INTERFACE__SRV__DETAIL__RESET_ODOM__FUNCTIONS_H_
 ...
 * calls
 * main_interface__srv__ResetOdom_Request__init().
...
/**
 * It calls
 * main_interface__srv__ResetOdom_Request__fini()
 ...
 * main_interface__srv__ResetOdom_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * main_interface__srv__ResetOdom_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * main_interface__srv__ResetOdom_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_main_interface
...
/**
 * It calls
 * main_interface__srv__ResetOdom_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_main_interface
...
/**
 * It allocates the memory for the array and calls
 * main_interface__srv__ResetOdom_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_main_interface
...
/**
 * It calls
 * main_interface__srv__ResetOdom_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MAIN_INTERFACE__SRV__DETAIL__RESET_ODOM__FUNCTIONS_H_
