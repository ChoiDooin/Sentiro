...
class Metaclass_Onoff(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from main_interface.srv import _onoff
...
class Onoff(metaclass=Metaclass_Onoff):
    from main_interface.srv._onoff import Onoff_Request as Request
    from main_interface.srv._onoff import Onoff_Response as Response
