...
class Metaclass_SaveColor(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from main_interface.srv import _save_color
...
class SaveColor(metaclass=Metaclass_SaveColor):
    from main_interface.srv._save_color import SaveColor_Request as Request
    from main_interface.srv._save_color import SaveColor_Response as Response
