...
#include "main_interface/srv/detail/onoff__rosidl_typesupport_fastrtps_c.h"
...
using _Onoff_Request__ros_msg_type = main_interface__srv__Onoff_Request;
...
size_t get_serialized_size_main_interface__srv__Onoff_Request(
  const void * untyped_ros_message,
...
static uint32_t _Onoff_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_main_interface__srv__Onoff_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_main_interface
size_t max_serialized_size_main_interface__srv__Onoff_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = main_interface__srv__Onoff_Request;
    is_plain =
      (
      offsetof(DataType, set) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Onoff_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_main_interface__srv__Onoff_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, main_interface, srv, Onoff_Request)() {
...
using _Onoff_Response__ros_msg_type = main_interface__srv__Onoff_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_main_interface
size_t get_serialized_size_main_interface__srv__Onoff_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Onoff_Response__ros_msg_type * ros_message = static_cast<const _Onoff_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_main_interface__srv__Onoff_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_main_interface
size_t max_serialized_size_main_interface__srv__Onoff_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = main_interface__srv__Onoff_Response;
    is_plain =
      (
...
static size_t _Onoff_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_main_interface__srv__Onoff_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, main_interface, srv, Onoff_Response)() {
...
// already included above
// #include "main_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "main_interface/srv/onoff.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, main_interface, srv, Onoff)() {
