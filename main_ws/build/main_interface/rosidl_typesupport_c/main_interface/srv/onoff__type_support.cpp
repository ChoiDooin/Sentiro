...
static const _Onoff_Request_type_support_symbol_names_t _Onoff_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, main_interface, srv, Onoff_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, main_interface, srv, Onoff_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, main_interface, srv, Onoff_Request)() {
  return &::main_interface::srv::rosidl_typesupport_c::Onoff_Request_message_type_support_handle;
}
...
static const _Onoff_Response_type_support_symbol_names_t _Onoff_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, main_interface, srv, Onoff_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, main_interface, srv, Onoff_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, main_interface, srv, Onoff_Response)() {
  return &::main_interface::srv::rosidl_typesupport_c::Onoff_Response_message_type_support_handle;
}
...
static const _Onoff_type_support_symbol_names_t _Onoff_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, main_interface, srv, Onoff)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, main_interface, srv, Onoff)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, main_interface, srv, Onoff)() {
  return &::main_interface::srv::rosidl_typesupport_c::Onoff_service_type_support_handle;
}
